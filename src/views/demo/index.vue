...
<template>
  ...
  <van-search v-model="inputValue" show-action shape="round" placeholder="请输入搜索关键词" background="#fff" class="search"
    @search="onSearch(1)">
    <template #action>
      <van-button type="primary" size="small" color="#004ff7" round @click="onClickButton">搜索</van-button>
    </template>
  </van-search>
